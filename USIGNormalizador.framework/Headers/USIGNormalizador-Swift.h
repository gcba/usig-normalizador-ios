...
SWIFT_MODULE_NAMESPACE_PUSH("USIGNormalizador")
...
@interface USIGNormalizadorController (SWIFT_EXTENSION(USIGNormalizador)) <UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating>
...
@interface USIGNormalizadorController (SWIFT_EXTENSION(USIGNormalizador)) <DZNEmptyDataSetDelegate, DZNEmptyDataSetSource>
